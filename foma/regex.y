...
network12: fend    { $$ = $1; } |
         ...
         SOMENONFINAL network RPAREN        { $$ = fsm_marksomenonfinal(fsm_copy($2)); } |
         ...
         BYTEMACHINE network RPAREN   { $$ = fsm_byte_machine(fsm_copy($2)); }   |
